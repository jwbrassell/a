...
# 5. Initialize database, run migrations, and setup actions
echo "Initializing database..."
run_remote "cd ~/flask_app && . venv/bin/activate && python3 init_database.py && flask db upgrade && python3 init_actions.py"
