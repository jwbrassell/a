...
def register_routes(blueprint):
    ...
    @blueprint.route('/api/synthetic/tests', methods=['GET', 'POST'])
    @requires_permission('awsmon_synthetic_access')
    def manage_tests():
    ...
    @blueprint.route('/api/synthetic/tests/<int:test_id>', methods=['PUT', 'DELETE'])
    @requires_permission('awsmon_synthetic_access')
    ...
    @blueprint.route('/api/synthetic/results')
    @requires_permission('awsmon_synthetic_access')
    def test_results():
